...
- **GIVEN** the topology contains 21 nodes and the readout data contains resident model count `1`, briefing time `08:30`, and Qwen throughput `~170 tok/s`
- **WHEN** the page loads
- **THEN** the hero shows one lowercase line equivalent to `nodes 21 · resident models 1 · briefing 08:30 · qwen ~170 tok/s`
